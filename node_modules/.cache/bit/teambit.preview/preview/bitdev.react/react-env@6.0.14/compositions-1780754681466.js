...
import {defaultMainModule, bitdevReactReactEnv6014MainModule} from "/home/user/football-intel/node_modules/@teambit/_local/preview-modules-c8b6e4110e1f22e7b74e0fb3564f6df162f2db35.mjs";
async function initializeModules() {

          let file_0_0;
          if (__bitShouldSurfaceFor("juju123.football/apps/football-prototype")) {
            try {
              file_0_0 = await import("/home/user/football-intel/football/apps/football-prototype/football-prototype.compositions.tsx");
            } 
            catch (err) {
              __bitSurfaceToOverlay(err, "juju123.football/apps/football-prototype");
              file_0_0 = { 
...
linkModules('compositions', {
  modulesMap: {
    ...
    "bitdev.react/react-env@6.0.14": bitdevReactReactEnv6014MainModule
  },
  isSplitComponentBundle: false,
  componentMap: {
    "apps/football-prototype": [file_0_0]
  }
});
}
...
if (__bitHot) {
  __bitHot.accept(["./football/apps/football-prototype/football-prototype.compositions.tsx","./node_modules/@teambit/_local/preview-modules-c8b6e4110e1f22e7b74e0fb3564f6df162f2db35.mjs"], () => {
