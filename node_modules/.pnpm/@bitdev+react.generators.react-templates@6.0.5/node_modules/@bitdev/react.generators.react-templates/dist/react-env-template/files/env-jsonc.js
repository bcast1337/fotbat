...
const envJson = () => {
	...
	"policy": {
		...
		"peers": [
			...
			},
			{
				...
				"version": "5.2.0",
				"supportedRange": "^5.2.0"
			},
			{
				"name": "@types/react",
				"version": "19.2.14",
				"supportedRange": "^19.0.2",
				"workspaceSingleton": true
			},
			{
			...
			},
			{
				"name": "jsdom",
				"version": "^29.0.0",
				"supportedRange": "^29.0.0"
			},
			{
				"name": "react-router-dom",
				"version": "^7.13.1",
				"supportedRange": "^7.13.1"
			},
			{
				"name": "react-router",
				"version": "^7.13.1",
			...
			},
			{
				"name": "graphql",
				"version": "^16.13.1",
				"supportedRange": "^16.13.1"
			},
			{
				"name": "@apollo/client",
				"version": "^4.1.6",
				"supportedRange": "^4.1.6"
			},
			{
				"name": "@mdx-js/react",
				"version": "3.1.1",
				"supportedRange": "^3.1.1",
				"workspaceSingleton": true
			},
			{
				"name": "@mdx-js/mdx",
			...
			},
			{
				...
				"version": "^1.2.1",
				"supportedRange": "~1.2.1"
			},
			{
				"name": "@rspack/plugin-react-refresh",
				"version": "^1.6.1",
				"supportedRange": "~1.6.1"
			},
			{
				"name": "oxlint",
				"version": "1.55.0",
			...
			},
			{
				...
				"version": "0.17.0",
				"supportedRange": "^0.17.0"
			},
			{
				"name": "@babel/core",
				"version": "7.29.0",
				"supportedRange": "~7.29.0"
			},
			{
				"name": "sass",
				"version": "1.98.0",
				"supportedRange": "^1.72.0"
			},
			{
				"name": "browserslist",
				"version": "4.28.1",
				"supportedRange": "4.28.1"
			},
			{
				"name": "@types/node",
				"version": "22.13.14",
			...
			},
			{
				...
				"version": "6.9.1",
				"supportedRange": "~6.9.1"
			},
			{
				"name": "@testing-library/dom",
				"version": "10.4.1",
				"supportedRange": "10.4.1"
			},
			{
				"name": "webpack",
				"version": "^5.88.2",
	...
	"patterns": {
		 ...
		 */
		"compositions": ["**/*.composition.*", "**/*.preview.*", "**/*.compositions.*"],
		/**
		...
		"tests": ["**/*.spec.*", "**/*.test.*", "!**/__snapshots__/**/*"],
		/* other dev files */
		"dev": ["**/*.fixture.*", "**/*.fixtures.*", "**/__snapshots__/**/*"]
	}
}
`,
    };
