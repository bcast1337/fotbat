...
const webpack_error_reporting_transformer_1 = require("./webpack-error-reporting.transformer");
class ReactPreview {
    ...
    getDevServer(context) {
        ...
        return webpack_webpack_dev_server_1.WebpackDevServer.from({
            ...
            transformers: [
                ...
                (0, webpack_error_reporting_transformer_1.createErrorReportingTransformer)(),
                ...this.transformers,
            ],
        });
    }
    ...
    getPreviewConfig() {
        return {
            ...
            // @ts-ignore this is a new field.
            // should be removed once this pr is merged and used in ripple CI 
            // https://github.com/teambit/bit/pull/10321
