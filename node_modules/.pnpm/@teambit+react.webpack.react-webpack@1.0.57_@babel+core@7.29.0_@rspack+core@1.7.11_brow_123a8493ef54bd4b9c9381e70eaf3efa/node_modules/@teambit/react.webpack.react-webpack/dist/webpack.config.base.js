...
function configBaseFactory(isEnvProduction = false) {
    ...
    return {
        ...
        resolve: {
            ...
            // Allow ESM-style imports that use explicit .js/.mjs/.cjs extensions
            // (e.g. `import './foo.js'`) to resolve to their TypeScript source
            // counterparts when running against source files instead of compiled dist.
            extensionAlias: {
                '.js': ['.ts', '.tsx', '.js', '.jsx'],
                '.mjs': ['.mts', '.mjs'],
                '.cjs': ['.cts', '.cjs'],
                        ...
                        // extensions .module.scss or .module.sass
                        {
                            ...
                            use: (0, webpack_modules_generate_style_loaders_1.generateStyleLoaders)((0, lodash_1.merge)({}, baseStyleLoadersOptions, {
                                ...
                                preProcessOptions: {
                                    ...
                                    options: {
                                        sassOptions: {
                                            quietDeps: true, // silence deprecation warnings from Dart Sass
